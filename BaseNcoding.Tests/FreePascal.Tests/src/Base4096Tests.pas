...
uses
  Classes, SysUtils, fpcunit, testregistry, BaseTests, uBase, uBase4096;

type

  TBase4096Tests = class(TTestCase)
...
begin
  ...
  F_btInstance.FConverter := TBase4096.Create();
end;

procedure TBase4096Tests.TearDown;
begin
  F_btInstance.Free;
end;

procedure TBase4096Tests.CallEncodeDecodeTest();
var
  i: integer;
begin
...
procedure TBase4096Tests.EncodeDecodeTest(const str: string);
var
...
procedure TBase4096Tests.CallEncodeDecodeTestDefaultTextEncoding();

begin
    EncodeDecodeTestDefaultTextEncoding(F_btInstance.sArray[0]);
end;

procedure TBase4096Tests.EncodeDecodeTestDefaultTextEncoding(const str: string);
var
  encoded, decoded: string;
begin
...
procedure TBase4096Tests.CallEncodeDecodeTestUnicodeTextEncoding();
var
  i: integer;
begin
  for i := 0 to Length(F_btInstance.sArray) - 1 do
...
procedure TBase4096Tests.EncodeDecodeTestUnicodeTextEncoding(const str: string);
var
  encoded, decoded: string;
begin
  F_btInstance.FConverter.Encoding := TEncoding.Default;
...
procedure TBase4096Tests.TailTests;
var
  testChar: char;
  strBuilder: string;
...
begin
  ...
  if ((F_btInstance.FConverter.HaveSpecial) and
    ...
    (TBase.IsPowerOf2(UInt32(Trunc(F_btInstance.FConverter.BitsPerChars))))) then
  begin
