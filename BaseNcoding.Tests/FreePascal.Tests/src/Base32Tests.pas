...
uses
  Classes, SysUtils, fpcunit, testregistry, BaseTests, uBase, uBase32;

type

  TBase32Tests = class(TTestCase)
...
begin
  ...
  F_btInstance.FConverter := TBase32.Create();
end;

procedure TBase32Tests.TearDown;
begin
  F_btInstance.Free;
end;

procedure TBase32Tests.CallEncodeDecodeTest();
var
  i: integer;
begin
...
procedure TBase32Tests.EncodeDecodeTest(const str: string);
var
...
procedure TBase32Tests.CallEncodeDecodeTestDefaultTextEncoding();
...
procedure TBase32Tests.EncodeDecodeTestDefaultTextEncoding(const str: string);
var
  encoded, decoded: string;
begin
...
procedure TBase32Tests.CallEncodeDecodeTestUnicodeTextEncoding();
var
  i: integer;
begin
  for i := 0 to Length(F_btInstance.sArray) - 1 do
...
procedure TBase32Tests.EncodeDecodeTestUnicodeTextEncoding(const str: string);
var
  encoded, decoded: string;
begin
  F_btInstance.FConverter.Encoding := TEncoding.Default;
...
procedure TBase32Tests.TailTests;
var
  testChar: char;
  strBuilder: string;
