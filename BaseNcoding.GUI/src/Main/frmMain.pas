...
uses
  ...
  System.Classes, System.Diagnostics, System.IniFiles, System.StrUtils,
  System.RTTI,
  Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ExtCtrls, Vcl.StdCtrls,
  Vcl.Samples.Spin, uBase, uBase32, uBase64, uBase85, uBase91, uBase128,
  uBase256,
  uBase1024, uBase4096, uZBase32, uBaseN, uBaseBigN, uStringGenerator, uUtils;
...
{$IF DEFINED (SUPPORT_PARALLEL_PROGRAMMING)}
  ...
  tbBitsPerChars.Text := method.BlockBitsCount.ToString + '/' +
    method.BlockCharsCount.ToString;
...
begin
  ...
  try
    ...
    tbOutputLength.Text := tempRes.Length.ToString();
    tbOutputSize.Text := method.Encoding.GetByteCount(tempRes).ToString();
...
begin
  tbInputLength.Text := mInput.Lines.Text.Length.ToString();
end;
